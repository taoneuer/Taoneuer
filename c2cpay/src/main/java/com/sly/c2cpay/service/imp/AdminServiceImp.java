...
public class AdminServiceImp implements AdminService {
     ...
     */
    @Override
    public List<ProductInfo> findGoods() {
     ...
     */
    @Override
    public List<TradeRecord> findTradeRecord() {
        return adminMapper.findTradeRecord();
    }
    /**
     * 根据id找用户
     * @param userID
     ...
     */
    @Override
    public Integer adduser(String userId,String userPassword){ return adminMapper.adduser(userId,userPassword);}
     ...
     */
    @Override
    public Integer addProduct(String productId,String productName,String productCategory,String productPrice,String ownerId)
    {return adminMapper.addProduct(productId,productName,productCategory,productPrice,ownerId);}
     ...
     */
    @Override
    public Integer deletetraderecord(String id){return adminMapper.deletetraderecord(id);}
}
